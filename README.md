...
2. Cargue el archivo `listings.csv` en la sección de "Archivos" (ícono de carpeta a la izquierda) dentro de una carpeta llamada `data/`, o ajuste la ruta de carga en el notebook.
